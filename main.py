...
def parse_args_and_config():
    ...
    parser.add_argument('--runner', type=str, default='ScoreSteincorrectorRunnner', help='The runner to execute')
    # parser.add_argument('--config', type=str, default='anneal.yml',  help='Path to the config file')
    parser.add_argument('--config', type=str, default='annealcorrect.yml',  help='Path to the config file')
    ...
    parser.add_argument('--datasets', type=str, default='celeba', help='Path for saving running related data.(specific)')

    args = parser.parse_args()
    # un_id = str(os.getpid())
    # run_time = time.strftime('%Y-%b-%d-%H-%M-%S')
    # args.doc = '_'.join([args.doc, run_id, run_time])
    args.log = os.path.join(args.run, 'logs', args.datasets, args.doc)
